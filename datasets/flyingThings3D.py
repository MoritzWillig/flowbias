...
class FlyingThings3d(data.Dataset):
    def __init__(self,
        ...
        for ii in range(0, len(flow_f_filenames)):
            ...
            if (self._reduce_every_nth is not None) and (ii % self._reduce_every_nth != 0):
                continue
...
class FlyingThings3dCleanValid(FlyingThings3d):
    def __init__(self,
                 args,
                 root,
                 reduce_every_nth=None,
        ...
        super(FlyingThings3dCleanValid, self).__init__(
            args,
            images_root=images_root,
            flow_root=flow_root,
            occ_root=occ_root,
