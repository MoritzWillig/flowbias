...
class PWCNetRecordable(nn.Module):
    """
    pwc net with modified forward method, to allow recording of the
    out_corr_relu, x1, flow - tensors between the en- and decoder.
    """

    def __init__(self, interface_func, args, div_flow=0.05):
        super(PWCNetRecordable, self).__init__()
        self.args = args
