...
# interface datasets
CONNECTOR_HOME_A=/data/dataA/model_interfaces/A_things/
CONNECTOR_HOME_B=/data/dataA/model_interfaces/W_things/
...
SAVE_PATH="$EXPERIMENTS_HOME/$MODEL-AW_33_things-$TIME"
