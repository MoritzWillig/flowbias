...
# interface datasets
CONNECTOR_HOME_A=/data/dataA/model_interfaces/W_sintel/
CONNECTOR_HOME_B=/data/dataA/model_interfaces/A_sintel/
...
SAVE_PATH="$EXPERIMENTS_HOME/$MODEL-WA_33_sintel-$TIME"
