...
# interface datasets
CONNECTOR_HOME_A=/data/dataA/model_interfaces/I_kitti/
CONNECTOR_HOME_B=/data/dataA/model_interfaces/A_kitti/
...
SAVE_PATH="$EXPERIMENTS_HOME/$MODEL-IA_33_kitti-$TIME"
...
--lr_scheduler_patience=53 \
--lr_scheduler_cooldown=26 \
