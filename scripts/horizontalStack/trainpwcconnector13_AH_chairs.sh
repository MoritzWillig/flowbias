...
# interface datasets
CONNECTOR_HOME_A=/data/dataA/model_interfaces/A_chairs/
CONNECTOR_HOME_B=/data/dataA/model_interfaces/H_chairs/
...
SAVE_PATH="$EXPERIMENTS_HOME/$MODEL-AH_33_chairs-$TIME"
