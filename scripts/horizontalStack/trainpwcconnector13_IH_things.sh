...
# interface datasets
CONNECTOR_HOME_A=/data/dataA/model_interfaces/I_things/
CONNECTOR_HOME_B=/data/dataA/model_interfaces/H_things/
...
SAVE_PATH="$EXPERIMENTS_HOME/$MODEL-IH_33_things-$TIME"
