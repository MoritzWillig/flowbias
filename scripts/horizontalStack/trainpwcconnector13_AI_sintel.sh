...
# interface datasets
CONNECTOR_HOME_A=/data/dataA/model_interfaces/A_sintel/
CONNECTOR_HOME_B=/data/dataA/model_interfaces/I_sintel/
...
SAVE_PATH="$EXPERIMENTS_HOME/$MODEL-AI_33_sintel-$TIME"
