...
# interface datasets
CONNECTOR_HOME_A=/data/dataA/model_interfaces/I_sintel/
CONNECTOR_HOME_B=/data/dataA/model_interfaces/W_sintel/
...
SAVE_PATH="$EXPERIMENTS_HOME/$MODEL-IW_33_sintel-$TIME"
